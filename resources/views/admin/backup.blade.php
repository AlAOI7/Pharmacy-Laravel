...
<div class="col-sm-7 col-auto">
	<h3 class="page-title">النسخة</h3>
	<ul class="breadcrumb">
		<li class="breadcrumb-item"><a href="{{route('dashboard')}}">لوحة التحكم</a></li>
		<li class="breadcrumb-item active">نسخة احتياطية</li>
	</ul>
</div>
<div class="col-sm-5 col">
    <form action="{{route('backup.store')}}" method="post">
        @csrf
        @method("PUT")
        <button class="btn btn-success float-right mt-2" type="submit">انشاء نسخة</button>
    </form>
