...
<div class="col-sm-5 col">
	<a href="#add_permission" data-toggle="modal" class="btn btn-success float-right mt-2">اضافة صلاحيات</a>
</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="POST" action="{{route('permissions.store')}}">
					...
					<button type="submit" class="btn btn-success btn-block">حفظ التغير</button>
				</form>
			</div>
		</div>
	</div>
...
<div class="modal fade" id="edit_permission" aria-hidden="true" role="dialog">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">تعديل الصلاحيات</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
